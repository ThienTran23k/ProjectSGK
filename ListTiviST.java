...
public class ListTiviST {
    public ArrayList<BaiTap> danhSach;
    BaiTap st = new BaiTap();

    public ListTiviST() {
        this.danhSach = new ArrayList<BaiTap>();
    }

    public ListTiviST(ArrayList<BaiTap> danhSach) {
        this.danhSach = danhSach;

    }

    // 1.them danh sach tivitt vao kho
    public void addST(BaiTap tvst){
        this.danhSach.add(tvst);
    }

    //2.in danh sach tivitt ra man hinh
    public void displayST() {
        for (BaiTap tiviST : danhSach) {
    ...
    public void arrangeST() {
        Collections.sort(this.danhSach, new Comparator<BaiTap>() {
            @Override
    ...
    public void readfileST(File file) {
        try {
            ...
            while (true) {
                ...
                danhSach.add(new BaiTap(ma, ten, xuatXu, heDieuHanh, namSx, hTrongkho,donGia,st.hien(day, month, year)));
            }
