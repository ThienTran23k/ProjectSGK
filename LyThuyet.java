...
public class LyThuyet extends SGK{
    ...
    public LyThuyet(String maSach, String tenSach,String nhaXuatBan , int namXuatBan , int soLuong,double giaSach,Date ngayNhap,Date ngayXuat) {
        super(maSach, tenSach, namXuatBan, nhaXuatBan, soLuong, giaSach, ngayNhap, ngayXuat);
    }
    public LyThuyet(String maSach, String tenSach, String nhaXuatBan, int namXuatBan, int soLuong, double giaSach,
            Date hien) {
    }
